    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('invoice/prefactura')); ?>">Facturación Electrónica</a>
                </li>
                <li class="active">
...
<div ng-controller="InvoiceController as vm" ng-init="vm.loadCombos(<?php echo e($_COOKIE['company_id']); ?>, <?php echo e($_COOKIE['branch_office_id']); ?>);vm.edit(<?php echo e($id); ?>);vm.company.id=<?php echo e($_COOKIE['company_id']); ?>">
                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        ...
                                        <div class="ibox-tools">
                                            ...
                                            <button type="button" ng-click="vm.updatePreInvoice(<?php echo e($id); ?>)" class="btn btn-sm btn-warning"><span class="fa fa-desktop"></span> Modificar Proforma</button>     
                                            <button type="button" ng-click="vm.updatePreInvoice(<?php echo e($id); ?>, 1)" class="btn btn-sm btn-info" ng-show="vm.EnableButtons"><span class="fa fa-list-alt"></span> Emitir Factura</button>
                                        </div>                
                                    </div>    
