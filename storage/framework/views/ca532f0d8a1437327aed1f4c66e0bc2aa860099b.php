<?php $__env->startSection('content'); ?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">                            
                            <a href="<?php echo e(url('creditnote/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nueva Nota de Crédito</a>                            
                        </div>
                    </div>                    
    ...
    <script>                 
        ...
        $(document).ready( function () {
            ...
            let apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/creditnoteDt/' + check;            
                ...
                'columns'    : [                    
                    ...
                    {data: 'amount',                 className: "text-center"},                    
                    {
                        ...
                        render: function (data){
                            let actions = '';
                            actions += '<center>'                      
                                    + '<a href="<?php echo e(url('creditnote/createPDF/')); ?>/'+ data.id +'" target="_blank" class="btn btn-xs btn-warning" title="Generar PDF" style="margin-right:3px"><i class="fa fa-file-pdf-o"></i></a>'
                                    ...
                                    + '<a href="<?php echo e(url('creditnote/downloadXML')); ?>/' + data.id +'"  class="btn btn-xs btn-primary" target="_blank" title="Descargar XML" style="margin-right:3px"><i class="fa fa-download"></i></a>';
                            return actions;
                        }
                    }
                ]
        ...
        function sendMail(id){
            swal({
                ...
                if (!isConfirm) return;
                $.ajax({
                    url: "<?php echo e(env('APP_URL', NULL)); ?>/creditnote/mail/" + id,
                    type: "GET",                                        
                    success: function () {
