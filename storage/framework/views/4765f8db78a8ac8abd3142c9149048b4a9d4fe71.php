<?php $__env->startSection('content'); ?>
    ...
    <div id="retention" ng-controller="TaxDocumentController as vm" ng-init="vm.loadCombos(<?php echo e($_COOKIE['company_id']); ?>, <?php echo e($_COOKIE['branch_office_id']); ?>);vm.company.id=<?php echo e($_COOKIE['company_id']); ?>; vm.setBranch(<?php echo e($_COOKIE['branch_office_id']); ?>)">
    ...
    <script>
        $(document).ready( function () {                    
            let apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/entitymasterdataEntityDt/23';            
