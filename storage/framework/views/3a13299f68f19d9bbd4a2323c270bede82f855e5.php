<?php $__env->startSection('content'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/product')); ?>">Productos</a>
                </li>
                <li class="active">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='ProductController as vm' ng-init="vm.edit(<?php echo e($id); ?>, 28)">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="row">
                        <form class="form-horizontal" name="FrmProduct" novalidate="novalidate" ng-submit="vm.update(<?php echo e(Cookie::get('company_id')); ?>)">    
                            <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-1 col-lg-10">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/product')); ?>">Volver</a>
                                </div>
                            </div>
                        </form>
                    </div>
