    ...
    <div id="client" class="wrapper wrapper-content animated fadeInRight" ng-controller="ClientController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">  
                            <a href="<?php echo e(url('product/import')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-file"></span> Importar Clientes</a>                          
                            <a href="<?php echo e(url('/client/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo Cliente</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/clientDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="<?php echo e(url("client/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
