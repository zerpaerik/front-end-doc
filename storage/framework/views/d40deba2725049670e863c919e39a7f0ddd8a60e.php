<?php $__env->startSection('content'); ?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">     
                            <a href="<?php echo e(url('product/import')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-file"></span> Importar Productos</a>                         
                            <a href="<?php echo e(url('product/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo producto</a>                            
                        </div>
                    </div>                    
    ...
    <script>        
        ...
        $(document).ready( function () {
            ...
            let apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/productDt/' + check;            
                ...
                'columns'    : [
                    ...
                    },
                    {
                        ...
                        render: function (data){
                            let actions = '';
                            actions += '<center>'                                    
                                    + '<a href="<?php echo e(url("product/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
