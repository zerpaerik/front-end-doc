<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="PermissionController as vm" ng-init="vm.readData(); vm.edit(<?php echo e($id); ?>)">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmPlan" novalidate="novalidate" ng-submit="vm.update(<?php echo e($id); ?>)">
