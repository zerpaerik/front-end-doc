<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='SupplierController as vm' ng-init="vm.edit(<?php echo e($id); ?>, <?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>)">
        <div class="row">
            <div class="col-lg-12">
