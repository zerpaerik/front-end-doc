    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Listar Guías de Remisión</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div id="client" class="wrapper wrapper-content animated fadeInRight" ng-controller="RemissionController as vm">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Lista Guías de Remisión</h5>
                        <div class="ibox-tools">  
                            <a href="<?php echo e(url('/remission/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nueva Guía de Remisión</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                let check = '<?php echo e($_COOKIE['branch_office_id']); ?>';                
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/remissionDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns' : [                    
                        ...
                        {data: 'social_reason'},                                                            
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'                      
                                        + '<a href="<?php echo e(url('remission/createPDF/')); ?>/'+ data.id +'" target="_blank" class="btn btn-xs btn-warning" title="Generar PDF" style="margin-right:3px"><i class="fa fa-file-pdf-o"></i></a>'
                                        ...
                                        + '<a href="<?php echo e(url('remission/downloadXML')); ?>/' + data.id +'"  class="btn btn-xs btn-primary" target="_blank" title="Descargar XML" style="margin-right:3px"><i class="fa fa-download"></i></a>';
                                return actions;
                            }
                        }
                    ]                     
            ...
            swal({
                ...
                if (!isConfirm) return;
                $.ajax({
                    url: "<?php echo e(env('APP_URL', NULL)); ?>/remission/mail/" + id,
                    type: "GET",                                        
