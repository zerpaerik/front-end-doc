<?php $__env->startSection('content'); ?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(url('user/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo usuario</a>                                 
                        </div>
                    </div>                    
    ...
    <script>        
        ...
        <?php if($_COOKIE['userRole'] == env('ROLE_SUPERADMIN', NULL)): ?>
            var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/userDtAll';
        <?php else: ?>
            var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/userDt/<?php echo e($_COOKIE['company_id']); ?>';
        <?php endif; ?>
                ...
                'columns'    : [
                    ...
                    },                                     
                    {
                        ...
                        render: function (data){
                            let actions = '';
                            actions += '<center>'
                                    + '<a href="<?php echo e(url("user/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
