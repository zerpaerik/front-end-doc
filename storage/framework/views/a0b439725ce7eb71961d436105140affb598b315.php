<?php $__env->startSection('content'); ?>
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="MailConfigurationController as vm" ng-init="vm.edit(<?php echo e($id); ?>)">
        <div class="row">
                        ...
                        <form class="form-horizontal" name="FrmMailConfig" novalidate="novalidate" ng-submit="vm.update()" >
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/mailconfiguration')); ?>">Volver</a>
                                </div>
                            </div>
                        </form>
                    </div>
