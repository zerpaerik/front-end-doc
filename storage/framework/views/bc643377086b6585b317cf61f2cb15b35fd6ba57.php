<?php $__env->startSection('content'); ?>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/dispatcher')); ?>">Transportistas</a>
                </li>
                <li class="active">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='DispatcherController as vm' ng-init="vm.readCompanyList(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>)">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" name="FrmDispatcher" novalidate="novalidate" ng-submit="vm.create()">  
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/dispatcher')); ?>">Volver</a>
                                </div>
                            </div>
