                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">                            
                            <a href="<?php echo e(url('branch/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nueva sucursal</a>                           
                        </div>                       
                    </div>                    
    ...
    <script>        
        ...
        $(document).ready( function () {
            ...
            <?php if($_COOKIE['userRole'] == env('ROLE_SUPERADMIN', NULL)): ?>
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/branchDtAll';
            <?php else: ?>
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/branchDt/<?php echo e($_COOKIE['company_id']); ?>';
            <?php endif; ?>            
                ...
                'columns'    : [
                    ...
                    {data: 'email',             className: "text-center"},
                    {
                        ...
                        render: function (data){
                            ...
                            let actions = '';
                            actions += '<center>'                                    
                                    + '<a href="<?php echo e(url("branch/edit/")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
                                    + button;
                            return actions;
                        }
                    }
