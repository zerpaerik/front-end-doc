    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/taxdocument')); ?>">Retenciones</a>
                </li>
                <li class="active">
                    <strong>Listar Retenciones</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div id="client" class="wrapper wrapper-content animated fadeInRight" ng-controller="TaxDocumentController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">  
                            <a href="<?php echo e(url('/taxdocument/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nueva Retención</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/taxdocument/retentionDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns' : [                    
                        ...
                        {data: 'supplier.social_reason'},                                        
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'                      
                                        + '<a href="<?php echo e(url('taxdocument/createPDF/')); ?>/'+ data.id +'" target="_blank" class="btn btn-xs btn-warning" title="Generar PDF" style="margin-right:3px"><i class="fa fa-file-pdf-o"></i></a>'
                                        ...
                                        + '<a href="<?php echo e(url('taxdocument/downloadXML')); ?>/' + data.id +'"  class="btn btn-xs btn-primary" target="_blank" title="Descargar XML" style="margin-right:3px"><i class="fa fa-download"></i></a>';
                                return actions;
                            }
                        }
                    ]                     
            ...
            swal({
                ...
                if (!isConfirm) return;
                $.ajax({
                    url: "<?php echo e(env('APP_URL', NULL)); ?>/taxdocument/mail/" + id,
                    type: "GET",                                        
