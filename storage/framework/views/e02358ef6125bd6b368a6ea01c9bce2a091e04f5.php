    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/supplier')); ?>">Transportistas</a>
                </li>
                <li class="active">
    ...
    <div id="dispatcher" class="wrapper wrapper-content animated fadeInRight" ng-controller="DispatcherController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">                                                      
                            <a href="<?php echo e(url('/dispatcher/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo Transportista</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/dispatcherDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="<?php echo e(url("dispatcher/edit")); ?>/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
