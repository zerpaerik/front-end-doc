<?php $__env->startSection('content'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('/branch')); ?>">Sucursales</a>
                </li>
                <li class="active">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='BranchController as vm' ng-init="vm.loadList(<?php echo e($_COOKIE['userRole']); ?>, <?php echo e($_COOKIE['company_id']); ?>)">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmBranch" novalidate="novalidate" ng-submit="vm.create(<?php echo e($_COOKIE['company_id']); ?>)">   
