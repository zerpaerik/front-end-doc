<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="EntityMasterDataController as vm" ng-init="vm.edit(<?php echo e($id); ?>)">
        <div class="row">
                        ...
                        <form class="form-horizontal" name="FrmEntityMasterData" novalidate="novalidate" ng-submit="vm.update()">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a class="btn btn-md btn-warning" href="<?php echo e(url('/entitymasterdata')); ?>">Volver</a>
                                </div>
                            </div>
