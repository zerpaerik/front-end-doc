<?php $__env->startSection('content'); ?>
    ...
    <div id="permission" class="wrapper wrapper-content animated fadeInRight" ng-controller="PermissionController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(url('/permission/create')); ?>" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nueva Permisología</a>
                        </div>
                    </div>                    
        ...
        <script>
            ...
            var apiUrl =  '<?php echo e(env('API_HOST', NULL)); ?>/permissionDt';                                         
                    ...
                    'columns'    : [                        
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="<?php echo e(url("permission")); ?>/'+data.role_id+'/edit" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
